...
""" Finetuning the library models for sequence classification on GLUE with RecAdam optimizer."""
...
def train(args, train_dataset, new_model, pretrained_model, tokenizer):
    """ Train the model """
...
def main():
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, new_model, pretrained_model, tokenizer)
